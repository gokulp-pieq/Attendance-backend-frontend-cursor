...
set CLASSPATH=%APP_HOME%\lib\AttendanceCursor2-1.0.0-all.jar

@rem Execute AttendanceCursor2
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ATTENDANCE_CURSOR2_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%ATTENDANCE_CURSOR2_EXIT_CONSOLE%" exit 1
exit /b 1
